...
public interface ProductRepository extends JpaRepository<ProductDetails, Long> {
	...
	List<ProductDetails> findByCategory(String categoryName);
...
//	@Query("select review.product from ReviewDetails review"
//			+"where avg(review.rating)>4")
//	List<ProductDetails> findProductByRating();
}
